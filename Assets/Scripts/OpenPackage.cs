...
/*
 * This script opens the package rewards for the user, both in classic gold mode and in crypto mode.
 * The crypto mode sends rewards to the player address provided earlier, using private key of the
...
public class OpenPackage : MonoBehaviour
{
	...
	// Because ERC20 contract on blockchain only supports 0 decimals we need to send only integers to the contract call
	...
	private IEnumerator SendRewards(int amount)
	{
